...
//        driver = new ChromeDriver(options);
        logger.info("Старт теста");
            ...
            getElement(By.xpath("//h2[contains(text(),\"Смартфоны и гаджеты\")]"));

            //Смартфоны и гаджеты
            WebElement smartfoGadget = driver.findElement(By.xpath("//h2[contains(text(),\"Смартфоны и гаджеты\")]"));
            smartfoGadget.click();

            getElement(By.xpath("//a[contains(text(),\"Смартфоны, мобильные телефоны\")]/following-sibling::div/descendant::a[contains(text(),\"Смартфоны\")]"));
            ...
            getElement(By.xpath("//span[@title=\"Samsung\"]"));
            WebElement smSamsung = driver.findElement(By.xpath("//span[@title=\"Samsung\"]"));
            smSamsung.click();

            getElement(By.xpath("//span[@title=\"Xiaomi\"]"));
            ...
            getElement(By.xpath("(//span[contains(text(),\"Сравнить\")]/ancestor::li/descendant::a[contains(text(),\"Смартфон Samsung\")])[1]"));
            ...
            // Сравнить
            getElement(By.xpath("(//span[contains(text(),'Сравнить') and contains(text(),'товара')])[1]"));
